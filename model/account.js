...
const AccountSchema = new Schema({
  ...
  virtual_currency: { type: Number, default: 0 },
});
...
exports.update = async function({ id, data }) {
  ...
  if (typeof data.virtual_currency === 'number') {
    updateData.$inc = { virtual_currency: data.virtual_currency };
    delete data.virtual_currency; 
  }
